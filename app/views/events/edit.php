...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="edit-event-form p-4">
                <h3 class="section-title mb-4">Edit Event</h3>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if (!empty($event['poster'])): ?>
                                    <div class="mb-2">
                                        <img src="/endama2/<?= htmlspecialchars($event['poster']) ?>" alt="Current Poster" class="current-poster" style="max-width:100%;max-height:200px;object-fit:cover;">
                                    </div>
                                    <small class="text-muted d-block mb-2">Current poster shown above. Upload a new one to replace it.</small>
                                <?php endif; ?>
